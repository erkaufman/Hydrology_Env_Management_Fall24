...
#24-hour data, 72-hour data change?!****

We began our analysis by preparing the data to analyze different storm event durations. We took a rolling sum across 3 days to get an estimated 72 hour storm event for each day. 
...
```{r}
#hazen
# Define probabilities of occurrence for 100 year, 50 year, 25 year,
#and 10 year flood
